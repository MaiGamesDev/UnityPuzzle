...
public class EmptyPuzzleSlot : MonoBehaviour, IDropHandler
{
    ...
    public void OnDrop(PointerEventData eventData)
    {
        ...
        PuzzleExample puzzlePiece = droppedPiece.GetComponent<PuzzleExample>();
        if (puzzlePiece != null && puzzlePiece.correctIndex == this.correctPieceIndex)
        {
            // 정답!
            Debug.Log("정답입니다: " + puzzlePiece.correctIndex);
